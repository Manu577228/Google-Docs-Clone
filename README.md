# Welcome to Google Docs Clone App!
...
2. npm install to install node modules on client & server.

3. npm start [client] & npm run start [server] to run the application on client & server.
